# VintaSoft WinForms Simple Barcode Reader Demo
...
3. Build the project ("SimpleBarcodeReaderDemo.Net7.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build SimpleBarcodeReaderDemo.Net7.csproj
   ```
